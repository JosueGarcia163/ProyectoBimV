...
VALUES ('Suite', '2 personas', 'Disponible', '2024-09-15', 1);
 
-- Inserción 2
INSERT INTO room (room_Type, capacity, availability, availability_date, hotel_id) 
VALUES ('Doble', '2 personas', 'No Disponible', '2024-09-16', 2);
 
-- Inserción 3
INSERT INTO room (room_Type, capacity, availability, availability_date, hotel_id) 
VALUES ('Individual', '1 persona', 'Disponible', '2024-09-17', 3);
 
-- Inserción 4
INSERT INTO room (room_Type, capacity, availability, availability_date, hotel_id) 
VALUES ('Familiar', '4 personas', 'Disponible', '2024-09-18', 4);
 
-- Inserción 5
INSERT INTO room (room_Type, capacity, availability, availability_date, hotel_id) 
VALUES ('Suite', '2 personas', 'No Disponible', '2024-09-19', 5);
 
INSERT INTO room (room_Type, capacity, availability, availability_date, hotel_id) 
VALUES ('Suite', '2 personas', 'No Disponible', '2024-09-19', 1);
