...
public class ReservationService implements IReservationService {
    ...
    // Método público para obtener una ReservationResponseDTO por ID
    public ReservationResponseDTO getReservationResponseById(Long idReservation) {
        Reservation reservation = findById(idReservation);
        if (reservation != null) {
            return responseDTO(reservation);
        } else {
            return null; // O manejar la ausencia de la reservación de otra manera
        }
    }
